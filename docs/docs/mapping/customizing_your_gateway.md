...
1. Write a custom implementation of [`Marshaler`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#Marshaler).

2. Register your marshaler with [`WithMarshalerOption`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#WithMarshalerOption).
...
You can see [the default implementation for JSON](https://github.com/peernova/grpc-gateway/blob/main/runtime/marshal_jsonpb.go) for reference.
...
You might not like [the default mapping rule](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#DefaultHeaderMatcher) and might want to pass through all the HTTP headers, for example:

1. Write a [`HeaderMatcherFunc`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#HeaderMatcherFunc).

2. Register the function with [`WithIncomingHeaderMatcher`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#WithIncomingHeaderMatcher)
...
To keep the [the default mapping rule](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#DefaultHeaderMatcher) alongside with your own rules write:
...
Use [`WithOutgoingHeaderMatcher`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#WithOutgoingHeaderMatcher). See [gRPC metadata docs](https://github.com/grpc/grpc-go/blob/master/Documentation/grpc-metadata.md) for more info on sending / receiving gRPC metadata, for example:
...
2. Register the filter with [`WithForwardResponseOption`](https://pkg.go.dev/github.com/peernova/grpc-gateway/runtime?tab=doc#WithForwardResponseOption)
